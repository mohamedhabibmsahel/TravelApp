...
import 'package:my_travel_app/views/recuperationPassword_View.dart';
...
Future<void> main() async {
  ...
  runApp(GetMaterialApp(
    ...
    getPages: [
      ...
      GetPage(name: '/RecuperationPasswordView', page: () =>  RecuperationPasswordView(),binding: BindingsBuilder.put(() => RecuperationPasswordController())),
    ],
  ));
}
...
class InitialBindings implements Bindings {
  ...
  void dependencies() async {
    ...
    Get.put<RecuperationPasswordController>(RecuperationPasswordController(), permanent: true);
